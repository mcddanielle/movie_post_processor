...
INCLUDEPATHS=-I/usr/include/c++/${GCCV} \
	...
	-I/usr/include/gsl \
        -I/usr/include/${ARCH} \
	-I/home/mcdermott/Codes-Scripts/All_Purpose_Movie_Processor/src \
...
ifeq (${DEBUG},1)
  ...
  LIBS=${LIBRARIES} -lm #-lgsl -lgslcblas #-std=c++11 #-L/usr/lib/x86_64-linux-gnu 
else
  CPUOPT= -O3 -mhard-float -msse2 -fno-strict-aliasing -w -W -Wextra -Wno-unused-result
  LIBS=${LIBRARIES} -lm #-lgsl -lgslcblas  #-L/usr/lib/x86_64-linux-gnu 
endif
